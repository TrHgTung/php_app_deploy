...
<head>
    ...
    <title>Get API Mẫu</title>
    <script src="../components/getApi.js" defer></script>
...
<body>
    ...
    <header>
        <a href="#" class="logo">API mẫu</a>
        <ul>
            <li><a href="../index.php" class="active">Trở về Home</a></li>
        </ul>
    </header>
    <section>
        ...
        <center>
            <div class="search">
                ...
                <input type="text" name="searchBar" id="searchBox" placeholder="Name (max: 100).." >
